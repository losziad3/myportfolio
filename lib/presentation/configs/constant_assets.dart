...
const String kaUrbnlance = "$basePath$projectPath/urbnlance.png";
const String kaAlAlfy = "$basePath$projectPath/al alfy.png";
const String kaEvaNav = "$basePath$projectPath/eva nav.jpeg";
...
const String kaGit = "$basePath$certificatePath/git.jpeg";
const String kaPayTabs =
    "$basePath$certificatePath/paytabs.jpeg";
const String kaFlutterUdemy =
    "$basePath$certificatePath/flutter udemy.png";
const String kaHackathon = "$basePath$certificatePath/hackathon.png";
const String kaCloud = "$basePath$certificatePath/cloud.png";
